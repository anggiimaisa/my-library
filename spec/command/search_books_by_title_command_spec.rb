require './app/command/search_books_by_title_command'

describe FindBookCommand do
  let(:title_to_be_searched) { 'Harry Potter' }
  ...
  context 'execute' do
    it 'should print filtered list of book if book title is found' do
      args = {
        "shelves" => [
          first_book_shelf, second_book_shelf, third_book_shelf
        ],
        "book_title" => title_to_be_searched
      }
